...
![批注块示例：带样式的文本分组、下划线和注音标记](assets/demo.png)
...
![快速开始：从零创建批注块并设置文本样式](assets/demo-quick-start.gif)
...
![创建批注块并用快捷分组预设设置文本样式](assets/demo-create-annotate-by-preset.gif)

**文本分组样式**

![调整文本分组样式：注音大小、位置和间距](assets/demo-text-group-style.gif)

在 **Text Group** 标签页中精细调整每个分组：注音大小、水平/垂直位置、间距、下划线和颜色。

**调整段落**

![调整段落外观：字号、最大宽度、行高和边框](assets/demo-paragraph-appearance.gif)

在 **Paragraph** 标签页中调整块外观：字号、最大宽度、行高、边框等。

**设置预设按钮**

![在设置中配置快捷分组预设按钮，带实时预览](assets/demo-preset-buttons.gif)

每个预设按钮都有独立的设置页，带实时预览：按钮标题、图标、颜色，以及完整的分组外观（注音文字、颜色、大小、位置等）。
